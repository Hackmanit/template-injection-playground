defmodule PhoenixWebappWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixWebappWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixWebappWeb.Gettext, "errors", msg, opts)
    end
  end
